...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'alpha':
				dialogue = CoolUtil.coolTextFile(Paths.txt('alpha/dialog'));
			case 'little-miss':
				dialogue = CoolUtil.coolTextFile(Paths.txt('little-miss/dialog'));
			case 'sunrise':
				dialogue = CoolUtil.coolTextFile(Paths.txt('sunrise/dialog'));
			case 'the-love':
				dialogue = CoolUtil.coolTextFile(Paths.txt('the-love/dialog'));
			case 'brazil':
				dialogue = CoolUtil.coolTextFile(Paths.txt('brazil/dialog'));
			case 'alive':
				dialogue = CoolUtil.coolTextFile(Paths.txt('alive/dialog'));
			case 'jeevan':
				dialogue = CoolUtil.coolTextFile(Paths.txt('jeevan/dialog'));
			case 'dystopia':
				dialogue = CoolUtil.coolTextFile(Paths.txt('dystopia/dialog'));
			case 'synthwave-little-miss':
				dialogue = CoolUtil.coolTextFile(Paths.txt('synthwave-little-miss/dialog'));
		}
		...
		switch (SONG.song.toLowerCase())
		{
				...
				case 'brazil':
				{
				  ...
				  case 'alive':
				  {
					  ...
					  bgLuz.animation.addByPrefix('idle', 'Luz 1 instância', 24);
				  ...
				  case 'little-miss':
				{
					...
					var bgFundo2:FlxSprite = new FlxSprite(-2913, -116);
					bgFundo2.frames = Paths.getSparrowAtlas('Incredibox/v2/fundo2');
					bgFundo2.animation.addByPrefix('idle', 'bg fundo2 instância 1', 24);
					...
					var bgFundo1:FlxSprite = new FlxSprite(-3203, -139);
					bgFundo1.frames = Paths.getSparrowAtlas('Incredibox/v2/fundo1');
					bgFundo1.animation.addByPrefix('idle', 'bg fundo instância ', 24);
