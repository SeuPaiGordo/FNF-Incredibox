...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var fnfBy:FlxText = new FlxText(5, FlxG.height - 66, 0, "FNF by Ninjamuffim99, PhantomArcade, etc", 12);
		fnfBy.scrollFactor.set();
		fnfBy.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(fnfBy);

		var sofarsogood:FlxText = new FlxText(5, FlxG.height - 52, 0, "Incredibox by SofarSoGood", 12);
		...
		var modBy:FlxText = new FlxText(5, FlxG.height - 38, 0, "Mod By Luiz Phellipe (SeuPaiGordo)", 12);
